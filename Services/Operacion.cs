    ...
    public class Operacion
    {
        ...
        public double descuento(double total)
        {
            if (total >5000)
            {
                ...
                Console.WriteLine("Tu costo original es de: " + total);
                Console.WriteLine("Tu descuento es de un monto de: " + (total * 0.1));
        ...
        public double meses(double total)
        {
            ...
            {
                double mes3 = total / 3;
                Console.WriteLine("Puedes pagar a 3 meses sin intereses por " + mes3 + " cada mes");
            }
            if (total > 10000)
            {
                double mes12 = total / 12;
                Console.WriteLine("Puedes pagar a 12 meses sin intereses por " + mes12 + " cada mes");
            }
            return total;
        }
    }
